...
df=pd.read_csv(r'C:\Users\rupesh.bobbili\Documents\Capstone\tourism_post_full.csv',sep=',',encoding = "ISO-8859-1")  ### Read CSV file
...
sw_list = ['amp','tourism','travel','also','https','http','industry','com','travelindustry','www','wanderlust','travelandtourism',
           'make','bit','get','tourist','tour','travelagent','travelblog','travelagency']
